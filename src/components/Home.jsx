                    ...
                    {cheluskinaItems.map((item, id) => (
                        <>
                            ...
                            <tr className='blue'>
                                ...
                                <th>{item.month}</th>
                                <th>
                                    {cheluskinaItems[id].id === '1' ?
                                        cheluskinaItems[id].light :
                                        (cheluskinaItems[id].light - cheluskinaItems[id - 1].light).toFixed(1)}
                                    {/* <input
                                        type="text"
                                        onChange={(e) => setLightRes(e.target.value)}
                                        value={cheluskinaItems[id].id === '1' ?
                                                cheluskinaItems[id].light :
                                                cheluskinaItems[id].light - cheluskinaItems[id - 1].light}
                                    /> */}
                                </th>
                                <th> {cheluskinaItems[id].id === '1' ?
                                    cheluskinaItems[id].gas :
                                    (cheluskinaItems[id].gas - cheluskinaItems[id - 1].gas).toFixed(1)}
                                </th>
                                <th>{cheluskinaItems[id].id === '1' ?
                                    cheluskinaItems[id].water :
                                    (cheluskinaItems[id].water - cheluskinaItems[id - 1].water).toFixed(1)}
                                </th>
                            </tr>
